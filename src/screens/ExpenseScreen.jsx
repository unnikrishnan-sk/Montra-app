...
const ExpenseScreen = () => {
    ...
    const handleExpense = async () => {
        if(isEnabled){
            ...
            const expenseData = {"amount" : amount, "category": category, "description": description, "wallet": wallet, createdAt: new Date()}
   ...
   <View style={{ backgroundColor: colorMix.red_100, height: HEIGHT }}>
    ...
    <RepeatModalComponent setModalVisible={setModalVisible} onButtonPress={onButtonPress} onNavigate="Attachment"/>
      ...
      <Modal
        ...
        visible={repeatModal}
        >
             <RepeatModalComponent setModalVisible={setModalVisible} onButtonPress={onButtonPress} />
