  ...
  return (
    <View style={{ backgroundColor: darkMode ? colorMix.dark_100 : colorMix.light_100, height: HEIGHT }}>
        ...
        <View style={{ borderTopWidth: 1, marginTop: HEIGHT*0.02, borderColor: colorMix.light_20, paddingHorizontal: WIDTH*0.05 }}>
            ...
            <Pressable onPress={()=>handleTheme(0)}
            ...
            { selectedTheme===0 && <View style={{ height: HEIGHT*0.04, width: HEIGHT*0.04, marginTop: HEIGHT*0.02, borderRadius: HEIGHT*0.02, backgroundColor: colorMix.violet_100, alignItems: 'center', justifyContent: 'center' }}>
            ...
            <Pressable onPress={()=>handleTheme(1)}
            style={{ flexDirection: 'row', justifyContent: 'space-between', marginTop: HEIGHT*0.03, paddingTop: HEIGHT*0.02 }}>

            <Text style={{ marginTop: HEIGHT*0.02, color: darkMode ? colorMix.light_100 : colorMix.dark_100, fontWeight: 500, fontSize: HEIGHT*0.022
            }}>Dark</Text>

            { selectedTheme===1 && <View style={{ height: HEIGHT*0.04, width: HEIGHT*0.04, marginTop: HEIGHT*0.02, borderRadius: HEIGHT*0.02, backgroundColor: colorMix.violet_100, alignItems: 'center', justifyContent: 'center' }}>
