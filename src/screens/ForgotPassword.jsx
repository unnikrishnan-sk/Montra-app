...
import { forgotPasswordDetails } from '../constants/dummyData'
  ...
  return (
    <View style={{ backgroundColor: darkMode ? colorMix.dark_100 : colorMix.light_100, height: HEIGHT }}>
        ...
        <View style={{ paddingHorizontal: WIDTH*0.05, marginTop: HEIGHT*0.12 }}>
            ...
            <Text style={{ fontSize: HEIGHT*0.03, fontWeight: '600', width: WIDTH*0.7, color: darkMode ? colorMix.light_100 : colorMix.dark_100
        ...
        <View style={{ marginTop: HEIGHT*0.04, paddingHorizontal: WIDTH*0.05 }}>
