import { arrow_right, bank_of_america, bca_bank, chase_bank, citi_bank, expense_icon, food_icon, income_icon, jago_bank, mandiri_bank, onboarding_1, onboarding_2, onboarding_3, pass_icon, paypal_bank, shopping_icon, subscription_icon } from "../assets";
