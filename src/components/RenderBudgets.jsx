...
// console.log(data);
    ...
    // console.log(RemainingAmnt,totalBudget);
  ...
  return (
    <Pressable 
    onPress={()=>navigation.navigate('detailbudget',{data})}
    style={{
        // borderWidth: 1,
        // height: HEIGHT*0.2,
        ...
        }}>Remaining ${RemainingAmnt<0 ? '0' : RemainingAmnt }
        </Text>
